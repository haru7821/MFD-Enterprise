...
| [docs/decisions/IDENTITY_MIGRATION.md](docs/decisions/IDENTITY_MIGRATION.md) | D17 — drawing, facility and plan identity, and what migrating them costs. **Deferred** |
| [docs/decisions/POST_PILOT_IMPROVEMENTS.md](docs/decisions/POST_PILOT_IMPROVEMENTS.md) | Recorded, unscheduled: nothing here starts before the first confirmation exists |
