...
export const LABELS = {
  ...
  field_planning_footprint: { ko: '설치 검토 점유 면적', en: 'Planning Footprint' },
  ...
  block_specification_data: { ko: '장비 사양 자료 (출처 확인됨)', en: 'Equipment Specification (Sourced)' },
  block_installation_data: { ko: '설치 기준 자료 (출처 확인됨)', en: 'Installation Requirements (Sourced)' },
  block_planning_footprint: { ko: '설치 검토 점유 면적 (설계 기준)', en: 'Planning Footprint (Planning Decision)' },
  ...
  group_maintenanceAccess: { ko: '점검 접근 공간', en: 'Maintenance Access' },
  group_portLocations: { ko: '연결부 위치', en: 'Service Port Locations' },
  group_installationRouting: { ko: '설치 배관·배선 경로', en: 'Installation Routing' },

  status_verified: { ko: '검증됨', en: 'Verified' },
  status_datasheet_verified: { ko: '데이터시트 검증됨', en: 'Datasheet Verified' },
